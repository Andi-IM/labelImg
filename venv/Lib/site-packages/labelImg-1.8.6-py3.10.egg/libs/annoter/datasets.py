...
from libs.annoter.general import check_requirements, xyxy2xywh, xywh2xyxy, xywhn2xyxy, xyn2xy, segment2box, segments2boxes, \
    resample_segments, clean_str
from libs.annoter.torch_utils import torch_distributed_zero_first
...
def auto_split(path='../coco', weights=(0.9, 0.1, 0.0), annotated_only=False):
